...
if __name__ == "__main__":
    ...
    from .network.openpose import baseline_op 
    ...
    parser.add_argument('--result_img_dir',default="./Pytorch_Pose_Estimation_Framework/ForSave/imgs/openpose3",
                        type=str)
    parser.add_argument('--result_json', default="./Pytorch_Pose_Estimation_Framework/ForSave/json/openpose/base.json",
                        type=str)
    ...
    parser.add_argument("--base_size",default=384,type=int) 
