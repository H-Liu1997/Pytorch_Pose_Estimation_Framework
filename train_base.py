...
from .network.openpose import baseline_op,resnet_loss
...
def cli():
    ...
    parser.add_argument('--loader',         default='OpenPifPaf',            type=str)

    #CMU_old.network_cli(parser)
    resnet_loss.loss_cli(parser)
    loader_factory.loader_cli(parser,"OpenPifPaf")
