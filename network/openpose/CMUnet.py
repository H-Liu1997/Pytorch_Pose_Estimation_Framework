...
class dense_block(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        self.conv1 = nn.Sequential( #nn.Conv2d(in_dim, 128, 1, 1, 0),
                                    ...
                                    nn.ReLU(num_parameters=128))
        self.conv2 = nn.Sequential(nn.Conv2d(128, 128, 3, 1, 1),
                                    nn.ReLU(num_parameters=128))
        # self.conv3 = nn.Sequential(nn.Conv2d(128, (out_dim-256), 3, 1, 1),
        #                             nn.ReLU(num_parameters=128))
        self.conv3 = nn.Sequential(nn.Conv2d(128, 128, 3, 1, 1),nn.ReLU(num_parameters=128))
        #self.conv4 = nn.Sequential(nn.Conv2d(384, out_dim, 1, 1, 0),nn.ReLU(num_parameters=128))
...
class dense_block_0(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        self.conv1 = nn.Sequential( #nn.Conv2d(in_dim, 128, 1, 1, 0),
                                    ...
                                    nn.ReLU(num_parameters=96))
        self.conv2 = nn.Sequential(nn.Conv2d(96, 96, 3, 1, 1),
                                    nn.ReLU(num_parameters=96))
        # self.conv3 = nn.Sequential(nn.Conv2d(128, (out_dim-256), 3, 1, 1),
        #                             nn.ReLU(num_parameters=128))
        self.conv3 = nn.Sequential(nn.Conv2d(96, 96, 3, 1, 1),nn.ReLU(num_parameters=96))
        #self.conv4 = nn.Sequential(nn.Conv2d(384, out_dim, 1, 1, 0),nn.ReLU(num_parameters=128))
        self.initialize_weight()
