...
class dense_block(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        # default inplace = False for PReLU
        ...
        #                             nn.PReLU(num_parameters=128))
        self.conv3 = nn.Sequential(nn.Conv2d(128, 128, 3, 1, 1),nn.PReLU(num_parameters=128))
        #self.conv4 = nn.Sequential(nn.Conv2d(384, out_dim, 1, 1, 0),nn.PReLU(num_parameters=128))
...
class dense_block_0(nn.Module):
    ...
    def __init__(self, in_dim, out_dim):
        ...
        # self.conv3 = nn.Sequential(nn.Conv2d(128, (out_dim-256), 3, 1, 1),
        #                             nn.PReLU(num_parameters=128))
        self.conv3 = nn.Sequential(nn.Conv2d(96, 96, 3, 1, 1),nn.PReLU(num_parameters=96))
        #self.conv4 = nn.Sequential(nn.Conv2d(384, out_dim, 1, 1, 0),nn.PReLU(num_parameters=128))
        self.initialize_weight()
...
class VGG_block(nn.Module):
    ''' 1. default have the bias
        2. using PReLU and 3 * max pooling
